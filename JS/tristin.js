...
var answerArr = [
    ...
    'no', 
    'n', ];
var userInput = prompt('Let\'s play a guessing game! I\'m going to ask you 5 yes or no questions.  Q1: Do I like Cars?').toLowerCase();


for (var i = 0; i < 5, i++) {
    
    while ((userInput !==  0))// anything in answerArray)) {
        userInput = prompt('yes or no').toLowerCase();
    }
// prompt user input
    if (i = 0)
    // if the counter is 1, ask question one,
